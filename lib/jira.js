...
const JiraApi = function( options ) {
    
  if( ! options ) {
      throw { message : 'No options passed to constructor', lib : 'js-jira' };
  }
  ...
  if (options.verbose !== true) { logger = { log: function() {} }; }
  ...
  this.doRequest = function(requestOptions, callback) {
      if(options.oauth && options.oauth.consumer_key && options.oauth.consumer_secret) {
